 ...
 *   og viser hvordan memoryallokering foreg�r i C++.
 *
 *   @file     EKS_03.CPP
...
//  PEKERE OG ARRAY:
    ...
    for (; i < 20; i++)            //  'i' er n� allerede 10 !!!
        iPeker[i] = 20 + i;        //  Fyller indeks 10-19 med verdiene 30-39:

    iPeker2 = iPeker + 20;         //  'iPeker2' peker p� element nr.20.
    for (i = 0; i < 10; i++)
...
// *************************************************************
    ...
    free(persPeker);                       //    memory-omr�dene.


// *************************************************************
// *********************  ALLTID HERETTER:  *********************
// **                 Glem 'malloc' og 'free' !!!              **
// **    N� er det KUN 'new' og 'delete' som gjelder !!!!!!    **
// **************************************************************
// *************************************************************
    ...
    cPeker = nullptr;              //  God vane � ha
    persPeker = nullptr;           //    (om de fortsatt kan/skal brukes).

                          //  KAN ogs� allokere bruker�nsket memory-st�rrelse:
    int lengde = lesInt("�nsket tekstlengde", 20, 80);
...
//  Huske dette ogs�! (ikke brukt engang siden den ble allokert):
    delete [] iPeker;              //  Frigir arrayen 'iPeker'.


//  Og dermed:  Snipp, snapp, snute:  
//              Ut med char-array - n� er det string som gjelder !!!
